...
interface MeizuApi {
	...
	int getSearchIdNumber(String viewIdName,boolean fresh);
	...
	boolean setDeviceType(String str,int intervalTime);
	...
	String takepicture(String file);
