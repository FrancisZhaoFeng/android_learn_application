package com.meizu.components.tools;

/**
 * Created by zhaoguofeng on 2016/8/18.
 */
...
public final class Logger {
    ...
    /**
     * PACKAGE_NAME is used for the Log, the name is a little different
    ...
    private static void logChunk(int logType, String tag, String chunk) {
        ...
        switch (logType) {
            case Log.ERROR:
                ...
                writeLog(chunk, Constant.USERPATH_WRITELOG);
                break;
            case Log.INFO:
     ...
     * 记录log到日志文件中
     */
    public static void writeLog(String logMessage, String logPath) {
        String msg = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "：" + logMessage;
        try {
